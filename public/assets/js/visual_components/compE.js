function drawEComponent(svg, table, componentName, componentType, redrawCallback) {
		...
		for (var i = 1; i < table[0].length; i ++) {
			var lastVal = table[table.length-1][i];
	  		...
	  		drawText(
	  			...
	  			0, colors[i-1], numberDisplay(lastVal, 'M'));
		}
